    ...
    <View className="flex-row justify-center items-center">
      ...
      <View className="flex-1 flex-row  justify-between items-center w-[100%] pl-2">
        <View>
          ...
          <Text className="text-xs">Quantidade: {qty}</Text>
          <Text className="text-xs">Data: {date}</Text>
          <Text className="text-xs">IdPedido: <Text className="font-semibold">#{orderId}</Text></Text>
        </View>
        <View className="flex-row  px-3 h-8 justify-center items-center">
          <Text className="font-extrabold">R${price*qty}</Text>
        </View>
      </View>
      </View>
    </View>
